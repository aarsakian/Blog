$(function(){var converter=new Showdown.converter();$('.article').each(function(){$(this).html(converter.makeHtml($(this).text()));});var actify=function(url){$('.nav-item').each(function(){$(this).removeClass('active');var link=$(this).children().first()[0].pathname;if(url===link){$(this).addClass('active');}});}
